...
const QURAN_VERSES = [
  { reference: 'Al-Baqarah 2:286', text: 'Allah does not burden a soul beyond that it can bear.' },
  { reference: 'Al-Imran 3:173', text: 'Allah is sufficient for us, and He is the best disposer of affairs.' },
  { reference: 'Al-Baqarah 2:255', text: 'Allah — there is no deity except Him, the Ever-Living, the Sustainer of existence.' },
  { reference: 'Ash-Sharh 94:5-6', text: 'For indeed, with hardship will be ease. Indeed, with hardship will be ease.' },
  { reference: 'Al-Baqarah 2:152', text: 'So remember Me; I will remember you. And be grateful to Me and do not deny Me.' },
  { reference: 'Al-Imran 3:139', text: 'So do not weaken and do not grieve, and you will be superior if you are true believers.' },
  { reference: 'Ar-Rad 13:28', text: 'Verily, in the remembrance of Allah do hearts find rest.' },
  { reference: 'Az-Zumar 39:53', text: 'Do not despair of the mercy of Allah. Indeed, Allah forgives all sins.' },
  { reference: 'Al-Anfal 8:46', text: 'And obey Allah and His Messenger, and do not dispute and lose courage and your strength would depart.' },
  { reference: 'Al-Baqarah 2:45', text: 'And seek help through patience and prayer, and indeed, it is difficult except for the humbly submissive.' },
  { reference: 'Al-Talaq 65:3', text: 'And whoever relies upon Allah — then He is sufficient for him. Indeed, Allah will accomplish His purpose.' },
  { reference: 'Al-Fatiha 1:1-2', text: 'In the name of Allah, the Entirely Merciful, the Especially Merciful. All praise is due to Allah, Lord of the worlds.' },
  { reference: 'Al-Hujurat 49:13', text: 'Indeed, the most noble of you in the sight of Allah is the most righteous of you.' },
  { reference: 'Al-Isra 17:44', text: 'The seven heavens and the earth and all that is therein praise Him, and there is not a thing but glorifies His praise.' },
  { reference: 'Yunus 10:62', text: 'Unquestionably, the allies of Allah will have no fear concerning them, nor will they grieve.' },
  { reference: 'Al-Mulk 67:2', text: 'He who created death and life to test you as to which of you is best in deed.' },
  { reference: 'Al-Qadr 97:3', text: 'The Night of Decree is better than a thousand months.' },
  { reference: 'Al-Ikhlas 112:1-2', text: 'Say: He is Allah, the One. Allah, the Eternal Refuge.' },
  { reference: 'Al-Asr 103:1-3', text: 'By time, indeed, mankind is in loss, except for those who have believed and done righteous deeds.' },
  { reference: 'Al-Baqarah 2:201', text: 'Our Lord, give us in this world good and in the Hereafter good and protect us from the punishment of the Fire.' }
]
