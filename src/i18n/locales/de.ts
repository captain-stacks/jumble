export default {
  translation: {
    ...
    'Show others this was sent via jumblewisp': 'Anderen zeigen, dass dies über jumblewisp gesendet wurde',
    ...
    Zaps: 'Zaps',
    'Enjoying jumblewisp?': 'Gefällt dir jumblewisp?',
    'Your donation helps me maintain jumblewisp and make it better! 😊':
      'Deine Spende hilft mir, jumblewisp zu pflegen und zu verbessern! 😊',
    ...
    'Welcome to jumblewisp': 'Willkommen bei jumblewisp',
    'jumblewisp is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      'jumblewisp ist ein Client, der sich auf das Durchsuchen von Relays konzentriert. Beginnen Sie mit der Erkundung interessanter Relays oder melden Sie sich an, um Ihren Following-Feed anzuzeigen.',
    'Explore Relays': 'Relays erkunden',
    'Choose a feed': 'Wähle einen Feed',
    'and {{x}} others': 'und {{x}} andere',
    selfZapWarning:
      'jumblewisp ist nicht verantwortlich für das, was passiert, wenn Sie sich selbst zappen. Fahren Sie auf eigene Gefahr fort. 😉⚡',
    ...
    'AI Agent': 'KI-Agent',
    'OpenAI API key not configured': 'OpenAI API-Schlüssel nicht konfiguriert',
    'Please set the VITE_OPENAI_API_KEY environment variable to use this feature.':
      'Bitte setzen Sie die Umgebungsvariable VITE_OPENAI_API_KEY, um diese Funktion zu nutzen.',
    'Type a message...': 'Geben Sie eine Nachricht ein...',
    'Failed to get response': 'Fehler beim Abrufen der Antwort'
  }
}
