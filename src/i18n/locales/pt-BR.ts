export default {
  translation: {
    ...
    'Show others this was sent via jumblewisp': 'Mostrar aos outros que isso foi enviado via jumblewisp',
    ...
    Reactions: 'Reações',
    Zaps: 'Zaps',
    'Enjoying jumblewisp?': 'Gostando do jumblewisp?',
    'Your donation helps me maintain jumblewisp and make it better! 😊':
      'Sua doação me ajuda a manter o jumblewisp e torná-lo melhor! 😊',
    ...
    'Welcome to jumblewisp': 'Bem-vindo ao jumblewisp',
    'jumblewisp is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      'jumblewisp é um cliente focado em navegar relays. Comece explorando relays interessantes ou faça login para ver o conteúdo das pessoas que você segue.',
    'Explore Relays': 'Explorar Relays',
    'Choose a feed': 'Escolha um feed',
    'and {{x}} others': 'e {{x}} outros',
    selfZapWarning:
      'jumblewisp não é responsável pelo que acontece se você zapear a si mesmo. Prossiga por sua conta e risco. 😉⚡',
    ...
    'Allow insecure connections description':
      'Permitir carregamento de recursos http:// e conexão a relés ws://. Pode desencadear avisos de conteúdo misto no navegador.',
    'AI Agent': 'Agente IA',
    'OpenAI API key not configured': 'Chave de API OpenAI não configurada',
    'Please set the VITE_OPENAI_API_KEY environment variable to use this feature.':
      'Por favor, defina a variável de ambiente VITE_OPENAI_API_KEY para usar este recurso.',
    'Type a message...': 'Digite uma mensagem...',
    'Failed to get response': 'Falha ao obter resposta'
  }
}
