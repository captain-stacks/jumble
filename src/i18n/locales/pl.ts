export default {
  translation: {
    ...
    'Show others this was sent via jumblewisp': 'Pokaż innym, że zostało to wysłane przez jumblewisp',
    ...
    Reactions: 'Odzewy',
    Zaps: 'Zapy',
    'Enjoying jumblewisp?': 'Podoba ci się jumblewisp?',
    'Your donation helps me maintain jumblewisp and make it better! 😊':
      'Twoja darowizna pomoże mi utrzymać i ulepszać jumblewisp! 😊',
    ...
    'Welcome to jumblewisp': 'Witamy w jumblewisp',
    'jumblewisp is a client focused on browsing relays. Get started by exploring interesting relays or login to view your following feed.':
      'jumblewisp to klient skupiający się na przeglądaniu transmiterów. Rozpocznij od odkrycia interesujących transmiterów lub zaloguj się, aby wyświetlić wpisy  obserwowanych użytkowników.',
    'Explore Relays': 'Przeglądaj transmitery',
    'Choose a feed': 'Wybierz transmitery',
    'and {{x}} others': 'i {{x}} innych',
    selfZapWarning:
      'jumblewisp nie ponosi odpowiedzialności za to, co się stanie, jeśli zappujesz samego siebie. Kontynuuj na własne ryzyko. 😉⚡',
